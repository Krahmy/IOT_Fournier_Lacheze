...
else if(mode=='21')
{
  data.Work_mode="HC2A";
  data.BatV=(input.bytes[0]<<8 | input.bytes[1])/1000;
  data.Temp_HC2A=parseFloat(((input.bytes[7]<<24>>16 | input.bytes[8])/10).toFixed(2));
	data.Hum_HC2A=parseFloat(((input.bytes[9]<<8 | input.bytes[10])/10).toFixed(1));
	//data.Gain_HC2A=parseFloat(input.bytes[11].toFixed(1));
